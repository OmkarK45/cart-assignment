...
const defaultMeta = {
  ...
  siteName: 'SimpleCommerce - A site to buy cloths',
  description:
    'Site to buy clothing! We have a wide range of clothing for you to choose from.',
  /** Without additional '/' on the end, e.g. https://theodorusclarence.com */
  url: 'https://cart-assignment.vercel.app',
  type: 'website',
  robots: 'follow, index',
